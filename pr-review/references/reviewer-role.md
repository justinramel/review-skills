...
You own either one file slice in `locality` mode or one review axis over the whole diff in an axis-specific mode.
...
The smell baseline, test-quality smells, severity ladder, and exact result shape live in the review contract.
